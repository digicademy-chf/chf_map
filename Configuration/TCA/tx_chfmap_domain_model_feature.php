...
return [
    'ctrl' => [
        ...
        'searchFields'             => 'title,projection,description,geo_json,iri,uuid,publication_date,revision_date,revision_number,editorial_note,import_origin,import',
        'enablecolumns'            => [
            'disabled' => 'hidden',
            'starttime' => 'starttime',
            'endtime' => 'endtime',
    ...
    'columns' => [
        ...
        'as_geodata_of_distribution' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_map/Resources/Private/Language/locallang.xlf:object.feature.asGeodataOfDistribution',
            'description' => 'LLL:EXT:chf_map/Resources/Private/Language/locallang.xlf:object.feature.asGeodataOfDistribution.description',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
