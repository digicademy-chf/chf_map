...
return [
    ...
    'columns' => [
        ...
        'l18n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_chfmap_domain_model_tile}.{#pid}=###CURRENT_PID###'
                    . ' AND {#tx_chfmap_domain_model_tile}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_source' => [
    ...
    'types' => [
        '0' => [
            'showitem' => 'hiddenParentResource,title,uriImage,',
        ],
    ],
];
